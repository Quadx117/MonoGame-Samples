...
class GameplayScreen : GameScreen
{
    ...
    private Vector2 _enemyPosition = new(100, 100);
                                ...
                                bool coveredByOtherScreen)
    {
        ...
        if (IsActive)
        {
            ...
            Vector2 targetPosition = new((ScreenManager.GraphicsDevice.Viewport.Width / 2) - (_gameFont.MeasureString("Insert Gameplay Here").X / 2),
                                         200);
