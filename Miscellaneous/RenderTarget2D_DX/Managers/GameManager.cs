...
using RenderTarget2D_DX.GameObjects;
...
internal class GameManager
{
    ...
    // NOTE(PERE): Modifying IsBorderless after modifying the width or height,
    // resets the width and height to their previous values. Modifying IsBorderless
    // first fixes this issue, but the rendering does not cover the whole screen, the
    // top left corner appears in the middle of the screen. To fix this, we need to
    // reset Game.Window.Position to the top left of the screen. This is only needed
    // with the WindowsDX backend, not with OpenGL.
    ...
    {
        // TODO(PERE): We should save to old position and resotre it when leaving
        // the borderless fullscreen mode or center the window like in OpenGL.
